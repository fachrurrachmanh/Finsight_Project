...
=========================
Class data laporan keuangan — tanpa @dataclass dan @property.
Semua nilai turunan dihitung via method biasa.
"""


class BalanceSheet:
    def __init__(self, tahun=0, kas_setara_kas=0.0, piutang_usaha=0.0,
                 persediaan=0.0, aset_lancar_lain=0.0, total_aset_lancar=0.0,
                 aset_tetap_neto=0.0, goodwill=0.0, aset_tidak_berwujud=0.0,
                 aset_tidak_lancar_lain=0.0, total_aset_tidak_lancar=0.0,
                 total_aset=0.0, utang_usaha=0.0, utang_jangka_pendek=0.0,
                 liabilitas_lancar_lain=0.0, total_liabilitas_lancar=0.0,
                 utang_jangka_panjang=0.0, liabilitas_tidak_lancar_lain=0.0,
                 total_liabilitas_tidak_lancar=0.0, total_liabilitas=0.0,
                 modal_disetor=0.0, laba_ditahan=0.0, ekuitas_lain=0.0,
                 total_ekuitas=0.0, jumlah_saham_beredar=0.0):
    ...
    def ncav(self):
        """Net Current Asset Value = Aset Lancar - Total Liabilitas"""
        return self.total_aset_lancar - self.total_liabilitas

    def nnwc(self):
        """Net-Net Working Capital (konservatif)"""
        return (self.kas_setara_kas * 1.00
...
class IncomeStatement:
    def __init__(self, tahun=0, pendapatan=0.0, harga_pokok_penjualan=0.0,
                 laba_kotor=0.0, beban_operasional=0.0, beban_penyusutan=0.0,
                 ebit=0.0, ebitda=0.0, beban_bunga=0.0, pendapatan_lain=0.0,
                 laba_sebelum_pajak=0.0, pajak=0.0, laba_bersih=0.0,
                 eps=0.0, dps=0.0, jumlah_saham_beredar=0.0):
...
class CashFlow:
    def __init__(self, tahun=0, arus_kas_operasi=0.0, depresiasi_amortisasi=0.0,
                 perubahan_modal_kerja=0.0, capex=0.0, akuisisi=0.0,
                 arus_kas_investasi=0.0, penerbitan_utang=0.0,
                 pembayaran_utang=0.0, penerbitan_saham=0.0,
                 dividen_dibayar=0.0, buyback_saham=0.0,
                 arus_kas_pendanaan=0.0, perubahan_kas=0.0):
...
class MarketData:
    def __init__(self, tahun=0, harga_saham=0.0,
                 market_cap=0.0, enterprise_value=0.0):
